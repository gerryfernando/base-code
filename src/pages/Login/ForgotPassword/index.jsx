...
import SendEmailSection from "./SendEmail";
import SuccessSendEmailSection from "./SuccessSendEmail";
  ...
  return (
    ...
    >
      ...
      <Grid paddingX={{ md: 5, lg: 15 }} item md={6} sm={12}>
        ...
        >
          {success ? (
            <SuccessSendEmailSection />
          ) : (
            <SendEmailSection setSuccess={setSuccess} />
          )}
        </Box>
      </Grid>
    </Grid>
